...
// Only add Swagger in local development
if (builder.Environment.IsDevelopment() && builder.Configuration["DisableSwagger"] != "true")
{
...
if (app.Environment.IsDevelopment() && builder.Configuration["DisableSwagger"] != "true")
{
    app.UseSwagger();
    app.UseSwaggerUI();
}
