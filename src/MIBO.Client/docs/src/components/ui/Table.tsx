...
export const Table = React.forwardRef<HTMLTableElement, React.TableHTMLAttributes<HTMLTableElement>>(
    ({ className, ...props }, ref) => (
        <table ref={ref} className={cn("min-w-full divide-y divide-zinc-200 dark:divide-zinc-800", className)} {...props} />
    )
);
...
export const TBody = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
    ({ className, ...props }, ref) => (
        <tbody ref={ref} className={cn("divide-y divide-zinc-200 bg-white dark:divide-zinc-800 dark:bg-zinc-950", className)} {...props} />
    )
);
...
export const TH = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
    ({ className, ...props }, ref) => (
        <th ref={ref} className={cn("px-4 py-3 text-left text-xs font-semibold text-zinc-700 dark:text-zinc-200", className)} {...props} />
    )
);
TH.displayName = "TH";
